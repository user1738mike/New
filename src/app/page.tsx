            ...
            <div className="mx-auto max-w-7xl px-6 md:px-12">
              <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                ...
                >
                  ...
                  <span className="text-sm">Welcome to Creator Plus</span>
                ...
                <h1 className="mt-8 text-4xl font-semibold md:text-5xl xl:text-5xl xl:[line-height:1.125]">
                  Make content{" "}
                  <span className="text-pink-500">the efficient way</span>{" "}
                  <br /> From idea to publish, effortlessly.
                </h1>
                <p className="mx-auto mt-8 hidden max-w-2xl text-wrap text-lg sm:block">
                  Innovative Content Creation Solutions for content creators and emerging businesses weary of the 
                  typical aesthetic methododlogy.
                </p>
